  ...
  <div class="row">
    <div class="col s12 m12 l12">
      ...
      <div id="responsive-table" class="card card card-default scrollspy">
        ...
        @if(in_array('create',Helper::getUserPermissionsModule('buyer_type_channel')))
            ...
            <div class="row">
              <div class="col s12">
                <form action="{{route($importUrl)}}" method="post" enctype="multipart/form-data">
                  ...
                  <a class="waves-effect waves-light left submit" target="_blank" href="{{asset('data-import-files/buyer-type-channelimport.csv')}}" download>{{__('locale.download_sample_file')}}
        ...
        <div class="card-content">
          ...
          <div class="row">
            ...
            <div class="col s12 table-result">
              ...
              @include('pages.buyer-type-channel.ajax-list')
